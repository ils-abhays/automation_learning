...
time.sleep(1)
driver.find_element(By.XPATH, "//input[@placeholder='Enter Event Producer']").send_keys("auto.customer@example.com")
time.sleep(2)
driver.find_element(By.XPATH, "//input[@placeholder='Enter Full Address']").send_keys("auto.customer@example.com")
time.sleep(2)
