...
# This is the list slicing operation. It extracts a portion of the tuple values based on the specified indices.
...
# tuple is immutable data type add, update & delete not allowed.
'''
